        ...
        for (int mx = startX; mx < endX; mx++)
        {
          ...
          {   // multiply with 16 filters at a time
            ...
            if (isPxInImg && isPxInModule)
            {
              ...
              for (int c = 0; c < numColors; c++)
              {
                shilterLoad[c * 16 * (16 + 1)] = (conv ? avFilters[filters + pxIdxInModule * numFilters + f + c * filterPixels * numFilters]
                                                  : avFilters[filters + (moduleIdx * numColors * filterPixels + pxIdxInModule) * numFilters + f + c * filterPixels * numFilters]);
              }
            }
        ...
        for (int mx = startX; mx < endX; mx++)
        {
          ...
          for (int f = 0; f < numFiltersPerGroup; f += 16)
          {
            ...
            if (isPxInImg && isPxInModule)
            {
              ...
              for (int c = 0; c < colorsPerThread; c++)
              {
                shFilterLoad[c * 16 * (16 + 1)] = (conv ? avFilters[filters +pxIdxInModule * numFilters + f + c * filterPixels * numFilters]
                                                   : avFilters[ filters +moduleIdx * numFilterColors * filterPixels * numFilters + pxIdxInModule * numFilters + f + c * filterPixels * numFilters]);
              }
            }
            tidx.barrier.wait();
            // Do some actual computation
        ...
        for (int mx = startX; mx < endX; mx++)
        {
          ...
          for (int f = 0; f < numFiltersPerGroup; f += 16)
          {
            ...
            for (int i = 0; i < colorsPerThread*B_Y; i+= B_X*B_Y/16)
            {
              ...
              {
                shFilterLoad[i * (16 + 1)] = (conv ? avFilters[filters + pxIdxInFilter * numFilters + f + i * filterPixels * numFilters]
                                              : avFilters[filters + moduleIdx * numFilterColors * filterPixels * numFilters + pxIdxInFilter * numFilters + f + i * filterPixels * numFilters]);
              }
            }
            tidx.barrier.wait();
            // Do some actual computation
        ...
        if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              //gpuFuncSetCacheConfig(conv_img_acts_manycolor<4, 32, 4, 2, false, true, true>, gpuFuncCachePreferShared);
              conv_img_acts_manycolor<4, 32, 4, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 2)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              //gpuFuncSetCacheConfig(img_acts_color<8, 2, false, true, true>, gpuFuncCachePreferShared);
              img_acts_color<8, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, false, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, false, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX,numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 2)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                      numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                            numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                            numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, true, true, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                      numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                      scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, true, false, true> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 2)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                         numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                               numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                               numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, false, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, false, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                         numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                         scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 4, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 2)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 2, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                       numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (numFilterColors % 16 == 0)
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              conv_img_acts_manycolor<4, 32, 1, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                                        numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<8, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<8, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<4, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<4, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        else
        {
          if  (checkCaseBounds)
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                             numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                             numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
          else
          {
            if (colorsPerThread == 4)
            {
              ...
              img_acts_mediumcolor<2, 4, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
            else
            {
              ...
              img_acts_mediumcolor<2, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                              numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                              numImgColors, numGroups, scaleTargets, scaleOutput, blockX, blockY,threadX);
            }
          }
        ...
        if (imgsPerThread == 8)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<8, 1, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<8, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<8, 3, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else if (imgsPerThread == 4)
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<4, 1, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<4, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<4, 3, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
        ...
        else
        {
          if (checkCaseBounds)
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, true, true, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                       numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                       scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
          else
          {
            if (numFilterColors == 1)
            {
              ...
              img_acts_color<2, 1, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 2)
            {
              ...
              img_acts_color<2, 2, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
            else if (numFilterColors == 3)
            {
              ...
              img_acts_color<2, 3, true, false, false> (hidActs, filters, targets, numModulesY, numModulesX, numImages,
                                                        numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride,
                                                        scaleTargets, scaleOutput, blockX, blockY, numFilterColors,threadX);
            }
          }
