...
static int cunn_Max_updateOutput(lua_State *L)
{
  ...
  // kernel:
  max_output(input_data, output_data, indices_data, THCudaTensor_nElement(input),
...
static int cunn_Max_updateGradInput(lua_State *L)
{
  ...
  // kernel:
  max_gradInput(gradInput_data, gradOutput_data, indices_data, THCudaTensor_nElement(gradInput),
