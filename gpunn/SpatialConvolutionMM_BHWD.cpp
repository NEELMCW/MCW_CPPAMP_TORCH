...
void imt2col_kernel(const int n, const float* data_im, const int height, const int width,
                   const int ksize, const int pad, const int stride, const int channels,
                   const int height_col, const int width_col, const int bidx, const int batch,
                   float* data_col)
{
...
void imt2col(const float* data_im, const int channels, const int height, const int width,
            const int ksize, const int pad, const int stride, const int batch, float* data_col)
{
